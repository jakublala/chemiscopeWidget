...
# -*- coding: utf-8 -*-
#
# chemiscopeWidget documentation build configuration file
#
...
project = 'chemiscopeWidget'
copyright = '2021, Jakub Lala'
author = 'Jakub Lala'
...
_version_py = os.path.join(repo, 'chemiscopeWidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'chemiscopeWidgetdoc'
...
latex_documents = [
    (master_doc, 'chemiscopeWidget.tex', 'chemiscopeWidget Documentation',
     'Jakub Lala', 'manual'),
]
...
man_pages = [
    (master_doc,
    'chemiscopeWidget',
    'chemiscopeWidget Documentation',
     [author], 1)
]
